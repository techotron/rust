...
fn main() {
    // collect() will turn the iterator from args() into a vector. We need to annotate
    //  the args variable with the type (Vec<String>) because Rust can't infer the type
